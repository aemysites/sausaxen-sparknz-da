...
## Environments
- Preview: https://main--sausaxen-sparknz-da--aemysites.aem.page/
- Live: https://main--sausaxen-sparknz-da--aemysites.aem.live/
- Block Library: https://main--sausaxen-sparknz-da--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `sausaxen-sparknz-da` directory in your favorite IDE and start coding :)
